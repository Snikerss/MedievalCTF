...
bool onServerProcessChat(CRules@ this, const string& in text_in, string& out text_out, CPlayer@ player)
{
	...
	if (isMod)
	{
		...
		else if (args.length > 0 && args[0] == "!addknight")
		{
			if (args.length == 2)
			{
				//1 top, 2 - top right, 3 - right ... 8 - top left
				CBlob@ k = server_CreateBlob("knight", -1, blob.getPosition());
				k.Tag("testshield");
				k.set_u8("debugdir", u8(parseInt(args[1])));
			}
		}
