...
void onTick(CBlob@ this)
{
	...
	if (this.hasTag("testshield"))
	{
		if (isServer() && this.exists("debugdir")) this.Sync("debugdir", true);
		u8 idx = this.get_u8("debugdir");
		Vec2f thispos = this.getPosition();
		switch (idx)
		{
			case 1:
			{	
				this.setAimPos(thispos+Vec2f(0, -1));
				break;
			}
			case 2:
			{	
				this.setAimPos(thispos+Vec2f(1, -1));			
				break;
			}
			case 3:
			{		
				this.setAimPos(thispos+Vec2f(1, 0));		
				break;
			}
			case 4:
			{			
