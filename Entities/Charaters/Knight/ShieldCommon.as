...
bool blockAttack(CBlob@ this, Vec2f direction, f32 damage)
{
	...
	f32 diff = 0.0f;
	if ((vars.direction.x == 1 || vars.direction.x == -1) && vars.direction.y == -3
	&& direction.y >= 4.5 && direction.y <= 6) // make shielding in top corners not blocking legs
	{
		return false;
	}
